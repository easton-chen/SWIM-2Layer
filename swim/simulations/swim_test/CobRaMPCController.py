...
if(order == 2):
    ...
    lterm = weights[0]*(C[0][0]*x_1+C[0][1]*x_2+D[0][2]*request_num+D[0][3]*res)**2+weights[1]*(u_1_dimmer-1)**2+weights[2]*((u_2_server-1)/2)**2
elif(order == 3):
